...
<html>
    ...
    <body>
        ...
        <s:form  method="post">
			<s:textfield name="sql.company" label="所属／会社"/>
			<s:textfield name="sql.name" label="お名前"/>
			<s:textfield type="number" name="sql.num" label="人数" max="5" min="1" value="1"/>
			<s:submit value="受 付"/>
		...
		会社名：<s:property value ="sql.company" /><br>
		名前：<s:property value ="sql.name" /><br>
        人数：<s:property value ="sql.num" /><br>
